...
import my.laundryapp.laundryappproviderv0.HomeActivity;
import my.laundryapp.laundryappproviderv0.R;
import my.laundryapp.laundryappproviderv0.adapter.MyCategoriesAdapter;
import my.laundryapp.laundryappproviderv0.common.Common;
import my.laundryapp.laundryappproviderv0.common.MySwipeHelper;
import my.laundryapp.laundryappproviderv0.common.SpaceItemDecoration;
...
public class CategoryFragment extends Fragment {
    ...
    private void initViews() {
        ...
        dialog1 = new SpotsDialog.Builder().setContext(getContext()).setCancelable(false).build();
        //dialog1.show();
